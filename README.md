...
> Launchpad fuer Token- und NFT-Releases auf der A-TownChain.
...
```
atc-launchpad (Token/NFT/Presale)
    +-- sales/ (Presale, Fair-Launch)
    +-- vesting/ - whitelist/
    +-- Integration: atc-contracts - atc-wallet
```
...
- **Purpose:** Launchpad-Service (L5, Roadmap M6).
- **Scope:** Layer L5, Domain launchpad — atc-launchpad als APPLICATION in der 23-Repo-Landschaft (AD-024/026).
- **Architecture:** Token-Launchpad der Chain (ID 658467).
- **Features:** Skelett.
